...
| :--- | :--- | :--- |
| `basic_ops.hpp` | `Bit::Basic` | Safe Set, Unset, Toggle, Check (64-bit). |
| `tricks.hpp` | `Bit::Trick` | LSB, Power of 2, **Trailing bits optimization**. |
| `builtins.hpp` | `Bit::Builtin` | Wrappers for GCC `__builtin_popcount`, `clz`, `ctz`. |
| `loops.hpp` | `Bit::Loop` | Submask iteration logic & Gosper's Hack. |
